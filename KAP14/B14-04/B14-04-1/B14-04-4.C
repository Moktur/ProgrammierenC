...
#include "b14-04-1.h"        /* Einbinden Definitionsdatei fuer Stapel */
...
void main(void)
{
    ...
    int           wert, erst_wert;      /* Elementwert */
        ...
        strcpy_s(liste, 21, "Stapel");  /* Steuerung ueber Listenkonstanten */
    #elif defined schlange
        strcpy(liste, "Schlange");
    #elif defined sortliste
        strcpy(liste, "Sortierte Liste");
    #endif
    ...
    printf("\nGewuenschter Knotenumfang (<=20): ");
    scanf_s("%u",&nelem);
    if (nelem < 0 || nelem > 20)         /* gegebenenfalls Korrektur */
        nelem = 20;
    printf("Wurzel Zufallszahlen (>= 0): ");
    scanf_s("%u",&seed);
