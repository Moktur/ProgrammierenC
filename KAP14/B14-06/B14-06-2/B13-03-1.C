...
/*     bereitgestellt. Die Datei b13-03-1.c stellt eine Anwendungsdatei
/*     fuer den ADT Artikelbestand in allen drei Varianten dar, waehrend
/*     die Definitionsdatei b13-03-1.h zu dieser Anwendungsdatei gehoert.
/*
/*****************************************************************************/
...
#include "b13-03-1.h"              /* Definitionsdatei fuer Anwendungsdatei */
...
/* Hinweis:
   Falls ANSI.SYS nicht verfuegbar ist:
   - #include "b15-06.h" entfernen
   - GOTOXY aus Makro PAUSE entfernen
   - BS_START entfernen in main
   - ATTR_AUS entfernen in main
   - CLRSCR entfernen in printf_artikel
   - GOTOXY entfernen in printf_artikel
   und ausfuehrbare Datei erneut erstellen
*/
